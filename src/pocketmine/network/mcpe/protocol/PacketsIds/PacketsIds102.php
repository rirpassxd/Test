...
final class PacketsIds102{
	...
	public const UPDATE_TRADE_PACKET = 0x4f;
	public const RESOURCE_PACK_DATA_INFO_PACKET = 0x50;
	public const RESOURCE_PACK_CHUNK_DATA_PACKET = 0x51;
	public const RESOURCE_PACK_CHUNK_REQUEST_PACKET = 0x52;
	public const TRANSFER_PACKET = 0x53;
