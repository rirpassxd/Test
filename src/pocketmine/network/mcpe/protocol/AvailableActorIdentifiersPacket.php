...
use pocketmine\network\mcpe\multiversion\actor\AvailableActorIdentifiersPalette;
...
class AvailableActorIdentifiersPacket extends DataPacket{
	...
	protected function encodePayload(){
        $this->put($this->namedtag ?? AvailableActorIdentifiersPalette::getActorIdsCache($this->getProtocol()));
	}
