 ...
 * @internal
 */
final class BlockPalette340 extends Palette{
	...
	public static function init() : void{
		...
		$runtimeIdMap = json_decode(file_get_contents(RESOURCE_PATH . "/vanilla/palette/340/BlockPalette.json"), true);
		$legacyIdMap = json_decode(file_get_contents(RESOURCE_PATH . "/vanilla/palette/block_id_map340.json"), true);
