 ...
 * @internal
 */
final class BlockPalette370 extends Palette{
	...
	public static function init() : void{
		$tag = (new NetworkLittleEndianNBTStream())->read(file_get_contents(RESOURCE_PATH . "/vanilla/palette/370/required_block_states.nbt"));
	...
	private static function setupLegacyMappings() : void{
		$legacyIdMap = json_decode(file_get_contents(RESOURCE_PATH . "/vanilla/palette/block_id_map370.json"), true);
		$legacyStateMap = (new NetworkLittleEndianNBTStream())->read(file_get_contents(RESOURCE_PATH . "/vanilla/palette/370/r12_to_current_block_map.nbt"));
