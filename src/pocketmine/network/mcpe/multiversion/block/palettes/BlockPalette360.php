 ...
 * @internal
 */
final class BlockPalette360 extends Palette{
	...
	public static function init() : void{
		$legacyIdMap = json_decode(file_get_contents(RESOURCE_PATH . "/vanilla/palette/block_id_map360.json"), true);

		$compressedTable = json_decode(file_get_contents(RESOURCE_PATH . "/vanilla/palette/360/BlockPalette.json"), true);
		$decompressed = [];
