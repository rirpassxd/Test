 ...
 * @internal
 */
final class BlockPalette330 extends Palette{
	...
	public static function init() : void{
		...
		$runtimeIdMap = json_decode(file_get_contents(RESOURCE_PATH . "/vanilla/palette/330/BlockPalette.json"), true);
		$legacyIdMap = json_decode(file_get_contents(RESOURCE_PATH . "/vanilla/palette/block_id_map330.json"), true);
