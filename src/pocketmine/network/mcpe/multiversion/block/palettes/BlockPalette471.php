 ...
 * @internal
 */
final class BlockPalette471 extends Palette{
	...
	public static function init() : void{
		$runtimeBlockStatesFile = file_get_contents(RESOURCE_PATH . "/vanilla/palette/471/runtime_block_states.dat");
