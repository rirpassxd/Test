...
final class ItemPalette766 extends Palette{
	/** @var int[] */
	...
	public static function init() : void{
		/** @var int[] $itemPalette */
		$itemMap = json_decode(file_get_contents(RESOURCE_PATH . "/vanilla/items/766/r16_to_current_item_map.json"), true);
		...
		$itemList = json_decode(file_get_contents(RESOURCE_PATH . "/vanilla/items/766/required_item_list.json"), true);
