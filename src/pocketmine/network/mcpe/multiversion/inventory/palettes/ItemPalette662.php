...
final class ItemPalette662 extends Palette{
	/** @var int[] */
	...
	public static function init() : void{
		/** @var int[] $itemPalette */
		$itemMap = json_decode(file_get_contents(RESOURCE_PATH . "/vanilla/items/662/r16_to_current_item_map.json"), true);
		...
		$itemList = json_decode(file_get_contents(RESOURCE_PATH . "/vanilla/items/662/required_item_list.json"), true);
