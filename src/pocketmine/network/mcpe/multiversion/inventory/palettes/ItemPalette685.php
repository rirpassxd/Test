...
final class ItemPalette685 extends Palette{
	/** @var int[] */
	...
	public static function init() : void{
		/** @var int[] $itemPalette */
		$itemMap = json_decode(file_get_contents(RESOURCE_PATH . "/vanilla/items/685/r16_to_current_item_map.json"), true);
		...
		$stringToIntMap["minecraft:stone_block_slab"] = 44;
		...
		$itemList = json_decode(file_get_contents(RESOURCE_PATH . "/vanilla/items/685/required_item_list.json"), true);
